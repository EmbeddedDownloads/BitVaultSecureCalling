...
struct _MSFactory{
	...
	//char *trxID;
	const char *trxID;
	const char *trxID_receive;
	const char *caller_flag;
	const char *call_receiver_flag;
	const char *public_key_receive;
	unsigned char *session_key_receive;
	unsigned char *generated_session_key;
	bool_t paused_call;
};
