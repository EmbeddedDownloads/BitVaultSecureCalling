...
//	private native Object inviteAddressWithParams(long nativePtrLc,long to, long nativePtrParam);
	private native Object inviteAddressWithParams(long nativePtrLc, long to, long nativePtrParam, String str);
	...
	public synchronized LinphoneCall inviteAddressWithParams(LinphoneAddress to, LinphoneCallParams params) throws LinphoneCoreException {
		long ptrDestination = ((LinphoneAddressImpl) to).nativePtr;
		long ptrParams = ((LinphoneCallParamsImpl) params).nativePtr;
		android.util.Log.d("invite call params 1", "invite call params");
//              String str = "74f2c3b8558be68b1dd364430ef46a4f8e25d0f5b35288cc39ceff57953e3968";
		String str = Utils.getSessionId(getContext());
		android.util.Log.d(LinphoneCoreImpl.class.getSimpleName(), "str :" + str);
		LinphoneCall call = (LinphoneCall) inviteAddressWithParams(nativePtr, ptrDestination, ptrParams, str);
		android.util.Log.d("invite call params", "invite call params");
		if (call != null) {
			return call;
		} else {
			throw new LinphoneCoreException("Unable to invite with params " + to.asString());
