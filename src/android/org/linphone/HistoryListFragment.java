 ...
 */
public class HistoryListFragment extends Fragment implements OnClickListener, ContactsUpdatedListener {
...
*/
	...
	class CallHistoryAdapter extends  BaseAdapter {
		private class ViewHolder {
			public TextView contact,sip_date,sip_time;
			public ImageView detail;
			public CheckBox select;
			public ImageView callDirection;
			//public BitVaultFont callDirection;
			public ImageView contactPicture;
			public RelativeLayout CallContact;

			public ViewHolder(View view) {
				contact = (TextView) view.findViewById(R.id.sip_uri);
				sip_date = (TextView) view.findViewById(R.id.sip_date);
				sip_time = (TextView) view.findViewById(R.id.sip_time);
				...
				//callDirection=(BitVaultFont)view.findViewById(R.id.icon);
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			String callDate = secondsToDisplayableString(log.getCallDuration());

			//Long longDate = Long.parseLong(callTime);
			holder.sip_time.setText(LinphoneUtils.timestampToHumanDate(getActivity(),timestamp,getString(R.string.history_detail_date_format)));

			holder.sip_date.setText(callDate);
			...
			if (log.getDirection() == CallDirection.Incoming) {
				address = log.getFrom();
				if (log.getStatus() == CallStatus.Missed) {
					/*holder.callDirection.setText("p");
					holder.callDirection.setTextColor(Color.parseColor("#ff0000"));*/
					holder.callDirection.setImageResource(R.drawable.call_missed);
				} else {
					/*holder.callDirection.setText("p");
					holder.callDirection.setTextColor(Color.parseColor("#FF6EC66E"));*/
					holder.callDirection.setImageResource(R.drawable.call_incoming);
				}
			} else {
				address = log.getTo();
				/*holder.callDirection.setText("p");
				holder.callDirection.setTextColor(Color.parseColor("#FF6EC66E"));*/
				holder.callDirection.setImageResource(R.drawable.call_outgoing);
			}
