...
public class LinphonePreferences {
    ...
    public static class AccountBuilder {
        ...
        public void saveNewAccount() throws LinphoneCoreException {
            android.util.Log.d("DEBUG TAG ", "saveNewAccount called ");
    ...
    public boolean isFriendlistsubscriptionEnabled() {
        return getConfig().getBool(AppKeyHelper.KEY_APP, "friendlist_subscription_enabled", false);
    }

    public void enabledFriendlistSubscription(boolean enabled) {
        getConfig().setBool(AppKeyHelper.KEY_APP, "friendlist_subscription_enabled", enabled);
    ...
    public boolean isEchoConfigurationUpdated() {
        return getConfig().getBool(AppKeyHelper.KEY_APP, "ec_updated", false);
    }
    ...
    public boolean useFrontCam() {
        return getConfig().getBool(AppKeyHelper.KEY_APP, "front_camera_default", true);
    }

    public void setFrontCamAsDefault(boolean frontcam) {
        getConfig().setBool(AppKeyHelper.KEY_APP, "front_camera_default", frontcam);
    }
...
//		return getConfig().getBool("app", "debug", false);
        SDKUtils.showLog(LinphonePreferences.class.getSimpleName(), "++ isDebugEnabled call ++");
        return getConfig().getBool("app", "debug", true);
    }
