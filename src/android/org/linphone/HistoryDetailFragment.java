...
public class HistoryDetailFragment extends Fragment implements OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		sipUri = getArguments().getString(AppKeyHelper.KEY_SIPURI);
		displayName = getArguments().getString(AppKeyHelper.KEY_DISPLAYNAME);
		pictureUri = getArguments().getString(AppKeyHelper.KEY_PICTUREURI);
		String status = getArguments().getString(AppKeyHelper.KEY_CALL_STATUS);
		String callTime = getArguments().getString(AppKeyHelper.KEY_CALL_TIME);
		String callDate = getArguments().getString(AppKeyHelper.KEY_CALL_DATE);
