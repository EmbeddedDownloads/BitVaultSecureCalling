...
set_target_properties(ortp PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libortp-arm64-v8a.so"
  IMPORTED_SONAME_RELWITHDEBINFO "libortp-arm64-v8a.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS ortp )
list(APPEND _IMPORT_CHECK_FILES_FOR_ortp "${_IMPORT_PREFIX}/lib/libortp-arm64-v8a.so" )
