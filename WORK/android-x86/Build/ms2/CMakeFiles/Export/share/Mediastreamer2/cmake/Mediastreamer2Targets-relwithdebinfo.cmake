...
set_target_properties(mediastreamer_base PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libmediastreamer_base-x86.so"
  IMPORTED_SONAME_RELWITHDEBINFO "libmediastreamer_base-x86.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS mediastreamer_base )
list(APPEND _IMPORT_CHECK_FILES_FOR_mediastreamer_base "${_IMPORT_PREFIX}/lib/libmediastreamer_base-x86.so" )
...
set_target_properties(mediastreamer_voip PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libmediastreamer_voip-x86.so"
  IMPORTED_SONAME_RELWITHDEBINFO "libmediastreamer_voip-x86.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS mediastreamer_voip )
list(APPEND _IMPORT_CHECK_FILES_FOR_mediastreamer_voip "${_IMPORT_PREFIX}/lib/libmediastreamer_voip-x86.so" )
